...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:1e3c72,100:2a5298&height=200&section=header&text=JuggernautSensei&fontSize=48&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=C%2FC%2B%2B%20%7C%20Game%20%7C%20Real-Time%20Graphics%20%7C%20Network&descAlignY=58&descSize=18" width="100%"/>

</div>

## 🧑‍💻 About Me

C/C++ 기반으로 **Windows 환경**에서 **실시간 3D 그래픽스**와 **네트워크 프로그래밍**을 파고드는 개발자입니다.
"엔진 밑바닥"에 관심이 많아서, 라이브러리부터 그래픽스 파이프라인까지 직접 만들어보며 원리를 파고드는 걸 좋아합니다.

### 🔨 무엇을 하나요?

- 🧩 C/C++을 이용한 다양한 고성능 라이브러리 개발
- 🎮 DirectX 11 기반 래스터라이저 컴퓨터 그래픽스 시뮬레이션 데모 개발
